...
$(function(){
    ...
    imgMountain.src = "images/door.png";
    imgEnemy = new Image();
    imgEnemy.src = "images/pixar.png";
    imgMountain.onload = function(){
        imgEnemy.onload = function(){
            for(var x in mapArray){
                for(var y in mapArray[x]){
                    if(mapArray[x][y]==1){
                        ctx.drawImage(imgMountain, 0,0,200,350,y*gridLength,x*gridLength,gridLength,gridLength);
                    }else if(mapArray[x][y]==3){
                        ctx.drawImage(imgEnemy, 340,485,80,80,y*gridLength,x*gridLength,gridLength,gridLength);
                    }
                }
            }
        }
